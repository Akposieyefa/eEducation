                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" readonly value="{{ $student->admission_no }}" />
                                                        </div>
                                                        <div class="col-md-6">
                                                                <label class="form-label">Current Class </label>
                                                                <input type="text" class="form-control" readonly value="{{ auth()->user()->student->level->name }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <br/>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                        ...
                                                                        <div class="custom-control custom-control-lg custom-radio mr-5 ml-3">
                                                                            <input type="radio" id="male" name="gender"  value="Male" {{ ($student->gender == "Male") ? "checked" : "" }} class="custom-control-input">
                                                                            <label class="custom-control-label" for="male">Male</label>
                                                                        </div>
                                                                        <div class="custom-control custom-control-lg custom-radio">
                                                                            <input type="radio" id="female" name="gender"  value="Female" {{ ($student->gender == "Female") ? "checked" : "" }} class="custom-control-input">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                        ...
                                                                        <select  name="lga_id" id="lga_id" class="form-control form-select" data-search="on">
                                                                            ...
                                                                            @foreach ($lgas as $lga)
                                                                                <option value="{{ $lga->id }}" {{ ($lga->id == $student->lga_id) ? 'selected' : '' }}>{{ $lga->name }}</option>
                                                                            @endforeach
                                                                        </select>
